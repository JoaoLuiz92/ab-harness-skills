...
|------|-----|----|-----------------|
| `JIRA_TASKS` | `next_actions.md` + `.specs/features/*/tasks.md` | Create/comment/transition via Atlassian MCP | Fallback local + `MCP_PENDING` in report |
...
- Feature specs in `.specs/features/<name>/`
